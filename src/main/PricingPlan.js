        ...
        <section id="pricing_plan">
            ...
            <div className="pricing pricing-palden">
                <div className="pricing-item features-item ja-animate" data-animation="move-from-bottom" data-delay="item-0" style={{minHeight: '497px'}}>
                    ...
                    <Link to="/hiring/team" className="pricing-action pricing-btn">Discuss Your Staffing Need! </Link>
                </div>
                ...
                <div className="pricing-deco" style={{background: 'linear-gradient(135deg,#a93bfe,#584efd)'}}>
                    ...
                    <div className="pricing-price"><span className="pricing-currency">$</span>2000
                    {/* <span class="pricing-period">/ mo</span> */}
                    </div>
                    <h3 className="pricing-title">Monthly (USD)</h3>
                </div>
                <ul className="pricing-feature-list">
                ...
                <Link to="/hiring/team" className="pricing-action">Discuss Your Staffing Need! </Link>
                </div>
                ...
                <div className="pricing-deco">
                    ...
                    <div className="pricing-price"><span className="pricing-currency">$</span>11000
                    {/* <span class="pricing-period">/ mo</span> */}
                    </div>
                    <h3 className="pricing-title">Monthly (USD)</h3>
                </div>
                <ul className="pricing-feature-list">
                <li className="pricing-feature">Build a SCRUM Team of 6 resources <br />Backend Developer</li>
