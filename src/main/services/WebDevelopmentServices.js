            ...
            <div className="container pb-3">
                ...
                <div className="row">
                    <div className=" col-md-6 col-12 csd_project_values">
                        <h4 className="benefits-item-title title-sub">Robust Front-end and Back-end</h4>
                    ...
                    <div className=" col-md-6 col-12 csd_project_values">
                        <h4 className="benefits-item-title title-sub">Technical assistance</h4>
                    ...
                    <div className=" col-md-6 col-12 csd_project_values">
                        <h4 className="benefits-item-title title-sub">Different Expertise</h4>
                    ...
                    <div className=" col-md-6 col-12 csd_project_values">
                        <h4 className="benefits-item-title title-sub">Security</h4>
        ...
        <section className="custom_software_development_section2 dedicated_team_section5_section">
            <div className="container">
                ...
                <div className="col-lg-6 col-md-12 col-xs-12 dedicated_team_section5">
                    <h3 className="font-weight-bold">Which web development services do we provide?</h3>
                ...
                <div className="col-lg-6 col-md-12 col-xs-12 dedicated_team_section5">
                    <h3 className="font-weight-bold">What circumstances are required for expert website development services?</h3>
                    <p>If you want to develop a web application or  new an existing one too but have in-house skills or corporate expertise, you need to hire a professional website development services company  that offers web development services. When you have any questions, you should ideally talk with an expert web provider.</p>
                    {/* <ul>
                        <li>What is Lorem Ipsum</li>
                        <li>Where does it come from</li>
                        <li>Why do we use it</li>
