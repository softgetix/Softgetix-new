    ...
    <Template>
            ...
            <div className="container pb-3">
                ...
                <div className="row">
                    <div className=" col-md-6 col-12 csd_project_values">
                        <h4 className="benefits-item-title title-sub">Whole Back-end Development cycle</h4>
                    ...
                    <div className=" col-md-6 col-12 csd_project_values">
                        <h4 className="benefits-item-title title-sub">End-to-end encryption</h4>
                    ...
                    <div className=" col-md-6 col-12 csd_project_values">
                        <h4 className="benefits-item-title title-sub">Scalability</h4>
        ...
        <section className="custom_software_development_section2 dedicated_team_section5_section">
            <div className="container">
                ...
                <div className="col-lg-6 col-md-12 col-xs-12 dedicated_team_section5">
                    <h3 className="font-weight-bold">What is the function of the back end?</h3>
                    <p>Server-side is required for data storage and management, app hosting, and better security. It also talks with the frontend to ensure that the data is shown correctly.</p>
                    {/* <ul>
                        <li>What is Lorem Ipsum</li>
                        <li>Where does it come from</li>
                        <li>Why do we use it</li>
