  ...
  return (
    <>
      ...
      <Template>
        <section
          id="staff_banner"
          className="custom_software_development_section1"
        >
                ...
                <div className="row">
                  <div className="col-lg-6 col-md-6 col-xs-12">
                    <div className="dedicated_team_section1_img p-5">
                      <img
                        src={enterpriseServices}
                        width="100%"
                        alt="EnterpriseServices"
                      />
                    </div>
                  </div>
                  <div className="col-lg-6 col-md-6 col-xs-12">
              ...
              <div className="col-md-12 dedicated_team_section2">
                <div className="row">
                  <div className=" col-md-6 col-12 csd_project_values">
                    ...
                    <p className="text">
                      When your country is facing talent crunch, a dedicated
                      development team is the best option for you. We can help
                      you quickly assemble individuals and your entire team with
                      a variety of technical skill sets, seniority levels,
                      English language proficiency and technical background.
                    </p>
                  </div>
                  <div className=" col-md-6 col-12 csd_project_values">
                    <h4 className="benefits-item-title title-sub">
                    ...
                    <p className="text">
                      Feel like you might use a few new developers for your
                      current project? No worry; we can assist you with that.
                      When your workload fluctuates, scale up or down as needed.
                      Leave the hiring and firing of programmers to us so you
                      can focus on enjoying the creation of your product.
                    </p>
                  </div>
                  <div className=" col-md-6 col-12 csd_project_values">
                    <h4 className="benefits-item-title title-sub">
                    ...
                    <p className="text">
                      Frequently interact with your software engineers and
                      participate in the software development process. Dedicated
                      programmers are hired specifically for your project. Have
                      a one-on-one discussion with the team to discuss your
                      demands and expectations. You'll be able to communicate
                      all of your objectives directly to the person in control
                      of design, development, or quality assurance as a result.
                    </p>
                  </div>
                  <div className=" col-md-6 col-12 csd_project_values">
                    <h4 className="benefits-item-title title-sub">
                    ...
                    <p className="text">
                      Every project, in our perspective, has its lessons to be
                      learned, and as bespoke software developers, our
                      experience has shown us that every project has its own
                      special difficulties. We have improved as developers over
                      the years, and we hope to keep doing so with each project
                      we do.
                    </p>
                  </div>
                  <div className=" col-md-6 col-12 csd_project_values">
                    ...
                    <p className="text">
                      As a result of their close-knit teams, experienced
                      developers are able to work on each project with a greater
                      degree of commitment. We know how to build each group to
                      include engineers who are not only skilled but also
                      familiar, as integration is what keeps people enthusiastic
                      and efficient.
                    </p>
                  </div>
                </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-6 col-md-12 col-xs-12 dedicated_team_section5">
                <h3 className="font-weight-bold">
                  What is a focused development team?
                </h3>
                <p>
                  A dedicated team is an engagement strategy that assumes the
                  creation of a focus on various to its own structure and
                  management. With this hiring strategy, you may selectively
                  hire a team based on requirements, knowledge level, and
                  budget. It is ideal for lengthy projects with hazy criteria or
                  large internal client company initiatives if they don't have
                  internal staff. While the administrative duties are handled by
                  the provider, the client can directly supervise this team.
                </p>
                {/* <ul>
              ...
              <div className="col-lg-6 col-md-12 col-xs-12 dedicated_team_section5">
                ...
                <p>
                  Depending on the requirement of a project, this team structure
                  consists of highly skilled tech experts. Web developers, QA
                  engineers,web app developers, and UX/UI designers are all
                  available from our organization to work only on your project.
                  This technique is an affordable solution because it integrates
                  technical expertise with low investment.
                </p>
                {/* <ul>
                        <li>What is Lorem Ipsum</li>
                        <li>Where does it come from</li>
