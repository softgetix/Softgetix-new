      ...
      <Template>
            ...
            <div className="container">
                ...
                <div className="col-lg-6 col-md-12 col-xs-12 dedicated_team_section5">
                    <div className="staff_title">
                        <h1>Dedicated <b className="orange-text">development</b><br/> team</h1>
                    </div>
                    <div className="staff_row_details">
                        <p>We provide dedicated teams of developers, User interface designers, and software testers in addition to mixed teams made up of various IT specialists.</p>
                        <p>To improve your project development, work with a dedicated team at softgetix inc. For projects of all sizes and in all industries, we at our firm offer the services of expert development teams. Our specialist teams are made up of skilled programmers, softgetix engineers, and other experts who give your project their entire focus.</p>
                        <p>By hiring a specialist software development team, you may outsource all administrative tasks and boost your on-site technical capability at the same time.</p>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-6 col-xs-12">
                            <div className="dedicated_team_section1_img p-5">
                                <img src={enterpriseServices} width="100%" alt="EnterpriseServices"/>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6 col-xs-12">
            ...
            <div className="container pb-3">
                ...
                <div className="row">
                    <div className=" col-md-6 col-12 csd_project_values">
                        <h4 className="benefits-item-title title-sub">Access To Talent</h4>
                        <p className="text">When your country is facing talent crunch, a dedicated development team is the best option for you. We can help you quickly assemble individuals and your entire team with a variety of technical skill sets, seniority levels, English language proficiency and technical background.</p>
                    </div>
                    <div className=" col-md-6 col-12 csd_project_values">
                        <h4 className="benefits-item-title title-sub">Simple Scalability</h4>
                        <p className="text">Feel like you might use a few new developers for your current project? No worry; we can assist you with that. When your workload fluctuates, scale up or down as needed. Leave the hiring and firing of programmers to us so you can focus on enjoying the creation of your product.</p>
                    </div>
                    <div className=" col-md-6 col-12 csd_project_values">
                        <h4 className="benefits-item-title title-sub">Direct Communication</h4>
                        <p className="text">Frequently interact with your software engineers and participate in the software development process. Dedicated programmers are hired specifically for your project.  Have a one-on-one discussion with the team to discuss your demands and expectations. You'll be able to communicate all of your objectives directly to the person in control of design, development, or quality assurance as a result.</p>
                    </div>
                    <div className=" col-md-6 col-12 csd_project_values">
                        <h4 className="benefits-item-title title-sub">Learn and grow for a better business</h4>
                        <p className="text">Every project, in our perspective, has its lessons to be learned, and as bespoke software developers, our experience has shown us that every project has its own special difficulties. We have improved as developers over the years, and we hope to keep doing so with each project we do.</p>
                    </div>
                    <div className=" col-md-6 col-12 csd_project_values">
                        <h4 className="benefits-item-title title-sub">Close-knit teams work better</h4>
                        <p className="text">As a result of their close-knit teams, experienced developers are able to work on each project with a greater degree of commitment. We know how to build each group to include engineers who are not only skilled but also familiar, as integration is what keeps people enthusiastic and efficient.</p>
                    </div>
                </div>
                </div>
                </div>
        ...
        <section className="custom_software_development_section2">
            ...
            <div className="row">
                ...
                <div className="row">
                    <div className=" col-md-6 col-12 csd_project_values">
                        <h4 className="benefits-item-title title-sub"><span>1</span>Send your specifications</h4>
                        <p className="text">You will get your expert developers more quickly the more information you submit with us. Give us a list of the experts you have, along with their senior level and technical stack, or get in touch with us to arrange a meeting so we can go over the details of your project.</p>
                    </div>
                    <div className=" col-md-6 col-12 csd_project_values">
                        <h4 className="benefits-item-title title-sub"><span>2</span>Examine vetted resumes</h4>
                        <p className="text">We will choose applicants based on your specifications. You will receive the appropriate profiles of any team members you desire, such as software engineers. If you want, you can ask for an interview with the candidates in person or by video call in our office.</p>
                    </div>
                    <div className=" col-md-6 col-12 csd_project_values">
                        <h4 className="benefits-item-title title-sub"><span>3</span>Supervising software developers</h4>
                        <p className="text">Your professional developers are under your direct supervision; there is no mediator. We only keep an eye on their performance and give the right place to work in it without interfering in your project.</p>
                    </div>
                    <div className=" col-md-6 col-12 csd_project_values">
                        <h4 className="benefits-item-title title-sub"><span>4</span>Experience stress-free development</h4>
                        <p className="text">As we manage the rest, step right into the development phase. We provide your team with all the resources, locations, and perks they require. Payroll, budgeting, employment, and recruitment are all our responsibility.</p>
                    </div>
                </div>
