          ...
          <div className="row text-center">
            <div className="col-lg-6 col-md-6 col-xs-12">
              <div className="counter">
                <img src={flight} alt="flight" width="50px"/>
            ...
            <div className="col-lg-6 col-md-6 col-xs-12">
              <div className="counter">
                <img src={rating} alt="rating" width="50px"/>
            ...
            <div className="col-lg-6 col-md-6 col-xs-12">
              <div className="counter">
                <img src={pencil} alt="pencil-and-ruler" width="50px"/>
            ...
            <div className="col-lg-6 col-md-6 col-xs-12">
              <div className="counter">
                <img src={years} alt="years" width="50px"/>
