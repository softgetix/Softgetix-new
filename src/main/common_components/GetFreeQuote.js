                                 ...
                                 <div className="row">
                                    ...
                                    <div className="col-md-6">
                                       <div className="form-group">
                                          ...
                                          <input type="text" minlength="10" maxlength="10" pattern="[0-9]+" className="form-control" name="mobile" value={mobile} onChange={(e) => setMobile(e.target.value)} id="phone" placeholder="Enter your contact no." required/>
                                       </div>
                                    </div>
                                    <div className="col-md-6">
                                       <div className="form-group">
