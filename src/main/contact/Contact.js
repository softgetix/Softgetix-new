...
function Contact() {
  ...
  let handleSubmit = async (e) => {
    ...
    try {
      let res = await fetch(
        "https://softgetix.com/SoftGetixAPI/public/api/contacts",
        {
          method: "POST",
          headers: {
      ...
      if (res.status === 200) {
        ...
        setMessage(
          "Contact Us support not available for now. Please try again later."
        );
      }
    } catch (err) {
      console.log(err);
                        ...
                        <form className="contactForm" onSubmit={handleSubmit}>
                          <div className="row">
                            ...
                            <div className="message col-md-12">
                              {message ? (
                                <p className="message_block">{message}</p>
                              ) : null}
                            </div>
                          </div>
                        </form>
